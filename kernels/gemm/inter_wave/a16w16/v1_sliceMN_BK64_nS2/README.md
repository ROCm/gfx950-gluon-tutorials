...
This version borrows the structure of the 4-wave [`a16w16/v8_sliceMN`](../../../intra_wave/a16w16/v8_sliceMN/README.md):
...
2. **BLOCK_K=64 with only 2 buffers.** A larger K-step means more compute per
   ...
   [v8 §4](../../../intra_wave/a16w16/v8_sliceMN/README.md#4-buffer-load-throughput-and-tcp-limitations)).
