...
<p align="center">
  <img src="../../intra_wave/a16w16/v9_beyond_hotloop/images/maturity_radar.png" alt="4-wave a16w16 v9 optimization maturity" width="300">
  &nbsp;&nbsp;
  <img src="images/maturity_radar.png" alt="8-wave a16w16 optimization maturity" width="300">
</p>

**Optimization maturity (rough).** Left = 4-wave a16w16 v9, right = 8-wave a16w16. Axes — codegen, global latency, LDS latency, LDS bank conflict, scheduling, L2 locality — are defined in the [`v0_naive` README](../../intra_wave/a16w16/v0_naive/README.md).
