...
MI355X. This is the 8-bit sibling of [`inter_wave/a16w16`](../a16w16/README.md): it
takes that kernel's `v1_sliceMN` warp-pipeline solution and swaps the 16-bit numerics
for 8-bit. Read the [`inter_wave/a16w16` README](../a16w16/README.md) first — this
...
`inter_wave/a16w16/v1_sliceMN_BK64_nS2`. Only the numerics move from 16-bit to 8-bit, exactly
as they do between the 4-wave `a16w16/v8_sliceMN` and `a8w8` kernels:

| | `inter_wave/a16w16/v1` (16-bit) | **`inter_wave/a8w8/v1` (8-bit)** |
|---|---|---|
