...
.LBB0_0:
	...
	s_add_u32 s8, s4, s1
	s_addc_u32 s4, s5, s2
	v_mad_u64_u32 v[6:7], s[2:3], s10, v64, v[2:3]
	s_mul_i32 s1, s11, 0x71
	v_mad_u64_u32 v[4:5], s[2:3], s11, v1, v[4:5]
	...
	buffer_load_dwordx4 v[66:69], v6, s[0:3], 0 offen
	buffer_load_dwordx4 v[70:73], v6, s[0:3], 0 offen offset:16
